define([ "animation", "input", "map" ], function(animation, input, map) {
    return {
        ...
        jump: function(target, event) {
            ...
            var collide = 
this.on.collision.call(this, target, event);
...
.frameData = this.animations[motionType.action].frames[index];
...
event: event
            ...
            if (sy <= 0 || collideData.passable === !1) result.triggers.push("top"), this.data.event.jump && (this.data.event.jump = !1, this.data.event
.fall = !0, result.event.action = "fall");
